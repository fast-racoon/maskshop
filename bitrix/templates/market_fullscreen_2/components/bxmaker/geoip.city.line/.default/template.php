...
<div class="bxmaker__geoip__city__line  bxmaker__geoip__city__line--default js-bxmaker__geoip__city__line"
	 ...
	 data-key="<?=$randString;?>" >
		 ...
		 <span class="bxmaker__geoip__city__line-label"><i class="fa fa-map-marker" aria-hidden="true" style="font-size: 20px;position: absolute; margin: 2px -4px;"></i>&nbsp;<?//=$arParams['~CITY_LABEL'];?></span>

	<div class="bxmaker__geoip__city__line-context js-bxmaker__geoip__city__line-context">
		<span class="bxmaker__geoip__city__line-name js-bxmaker__geoip__city__line-name js-bxmaker__geoip__city__line-city" style=" color: #576e75; vertical-align: middle; text-decoration: none; font-size: 13px; margin: 0 8px 0 5px; "><?=$oManager->getFirstNotEmpty(array($arResult['CITY_DEFAULT'], Loc::getMessage($BXMAKER_COMPONENT_NAME . 'CITY_DEFAULT') ));?></span>
