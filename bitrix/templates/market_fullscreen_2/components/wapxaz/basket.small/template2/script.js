                ...
                success: function(data){
                    ...
                    if (basket.delayWindow != true && delay || favor){
                        ...
                        BXReady.basketPopup = BX.PopupWindowManager.create("basketPopup", null, {
                                ...
                                content: '<div style="width:400px;height:400px; text-align: center;"><span style="position:absolute;left:50%; top:50%"><img src="/images/wait.gif"/></span></div>',
                                events: {
...
//                    }
        ...
        basketButtonsInit: function(){
            ...
            $(document).on(
                ...
                function(){
                    window.BXReady.showAjaxShadow('body','body-shadow');
                    basket.addItem($(this).parents('form'));
                    return false;
                }
            );
            ...
            $(document).on(
                ...
                function(){
					...
					if (isNaN(newQty)) {
						newQty = parseInt($(this).parent('.topBlock').children('.bxr-quantity-text[data-item='+itemID+']').val());
					}
