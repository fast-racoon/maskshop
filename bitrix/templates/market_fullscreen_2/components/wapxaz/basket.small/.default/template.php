...
<?endif;?>
	...
	<?if (!isset($_REQUEST['ajaxbuy']) || $_REQUEST['ajaxbuy'] != "yes"):?>
			...
			<div>
				<?// Basket delay Info?>
                  <a href="javascript:void(0);" data-group="basket-group" class="bxr-basket-indicator bxr-indicator-favor bxr-font-hover-light"  data-child="bxr-favor-body" style="display:none;">
...
$idDelay = "bxr-favor-body";
	...
	?>
	<div id="<?=$idDelay?>" class="basket-body-container" data-group="basket-group" >
