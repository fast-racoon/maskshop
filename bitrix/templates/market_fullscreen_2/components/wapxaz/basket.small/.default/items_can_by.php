...
<button class="bxr-close-basket">X</button>
			...
			<tr>
				...
				<td class="basket-action last">
					<button id="button-delay-<?=$arBasketItem["ID"]?>" class="icon-button-delay" value="" data-item="<?=$arBasketItem["ID"]?>" style=" background: none; ">
						...
						<img title="Добавить в избранное" src="/images/ico_like.png">
					</button>
					<button id="button-delay-<?=$arBasketItem["ID"]?>" title="Удалить из корзины" class="icon-button-delete" value="" data-item="<?=$arBasketItem["ID"]?>" style=" background: none; ">
	...
	<div class="basket-body-title basket-body-bottom-buttons">
