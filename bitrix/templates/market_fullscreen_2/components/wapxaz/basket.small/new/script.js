$(document).ready(function(){
    ...
    window.BXReady.Market.Basket = {
        ...
        refreshData: function(){
            ...
            if($(".action-block .favor-wrapper a span.favor-count").length > 0){
                $(".action-block .favor-wrapper a span.favor-count").html(basket.list.FAVOR.length);
            }else{
                $(".action-block .favor-wrapper a svg").after("<span class='favor-count'>"+basket.list.FAVOR.length+"</span>");
            }
            
            if(basket.list.FAVOR.length == 0){
                $(".action-block .favor-wrapper a span.favor-count").html("");
            }
