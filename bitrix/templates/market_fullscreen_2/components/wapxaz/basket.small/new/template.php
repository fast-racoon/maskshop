...
$_SESSION["BXR_BASKET_TEMPLATE"] = ".default";//"new";
?>
<?//file_put_contents($_SERVER["DOCUMENT_ROOT"] . "/1s_log.txt", var_export($_REQUEST, true), FILE_APPEND);?>
...
<?endif;?>
	...
	<?if (!isset($_REQUEST['ajaxbuy']) || $_REQUEST['ajaxbuy'] != "yes"):?>
		<div id="bxr-basket-row" class="basket-body-table-row bxr-basket-row-top text-center">
			<div class="">
				<?// Basket can by Info?>
	...
	?>
				<div id="<?=$idDelay?>" class="basket-body-container<?if(count($arResult["BASKET_ITEMS"]["CAN_BUY"])==0){?> noOrders_top<?}?>" data-group="basket-group" data-state="hide">
	...
	<?if (!isset($_REQUEST['ajaxbuy']) || $_REQUEST['ajaxbuy'] != "yes"):?>
			...
			<div>
				<?// Basket delay Info?>
                  <a title="Избранное" href="javascript:void(0);" data-group="basket-group" class="bxr-basket-indicator bxr-indicator-favor bxr-font-hover-light"  data-child="bxr-favor-body" style="display:none;">
...
$idDelay = "bxr-favor-body";
	...
	?>
	<div id="<?=$idDelay?>" title="Избранное" class="basket-body-container" data-group="basket-group" >
