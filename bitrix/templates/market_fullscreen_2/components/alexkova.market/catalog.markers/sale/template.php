...
<div id="bxr-markers-container">
		...
		<div class="col-lg-12 lent">
			...
			<?foreach($arResult["MARKERS_LIST"] as $cell):
				...
				case "HIT":?>
					...
					break;
				case "MUSTHAVE":?>
					<!--<div class="bxr-markers-group" id="marc_tabMUSTHAVE" data-slide="MUSTHAVE" data-type="markers"><?=GetMessage('MUST_HAVE_BUTTON')?></div>-->
					<?
					if (!$firstMarker) $firstMarker = "MUSTHAVE";
					break;	
				case "MONTHHIT":?>
					<!--<div class="bxr-markers-group" id="marc_tabMONTHHIT" data-slide="MONTHHIT" data-type="markers"><?=GetMessage('MONTHHIT_BUTTON')?></div>-->
					<?
					if (!$firstMarker) $firstMarker = "MONTHHIT";
					break;									
				case "NEWBANER":?>
					<!--<div class="bxr-markers-group" id="marc_tabNEWBANER" data-slide="NEWBANER" data-type="markers"><?=GetMessage('NEWBANER_BUTTON')?></div>-->
					<?
					if (!$firstMarker) $firstMarker = "NEWBANER";
					break;		
				case "SALEBANER":?>
					<!--<div class="bxr-markers-group" id="marc_tabSALEBANER" data-slide="SALEBANER" data-type="markers"><?=GetMessage('SALEBANER_BUTTON')?></div>-->
					<?
					if (!$firstMarker) $firstMarker = "SALEBANER";
					break;						
				default ;
			}?>
			<?endforeach;?>
	...
	<?foreach($arResult["MARKERS_LIST"] as $cell):
		...
		case "MUSTHAVE":?>
			<div class="col-xs-12 hidden-lg hidden-md hidden-sm">
				<div id="bxr-mobile-name-MUSTHAVE"
					 class="bxr-marker-mobile-names bxr-color-button"
					 data-slide="MUSTHAVE"
					 data-unicum="<?=$unicum?>">
					<?=GetMessage('MUST_HAVE_BUTTON')?>
				</div></div>
			<div id="mark-panel-MUSTHAVE" class="bxr-carousel"></div>
			
			<?
			break;
		case "MONTHHIT":?>
			<div class="col-xs-12 hidden-lg hidden-md hidden-sm">
				<div id="bxr-mobile-name-MONTHHIT"
					 class="bxr-marker-mobile-names bxr-color-button"
					 data-slide="MONTHHIT"
					 data-unicum="<?=$unicum?>">
					<?=GetMessage('MONTHHIT_BUTTON')?>
				</div></div>
			<div id="mark-panel-MONTHHIT" class="bxr-carousel"></div>
			
			<?
			break;	
		case "SALEBANER":?>
			<div class="col-xs-12 hidden-lg hidden-md hidden-sm">
				<div id="bxr-mobile-name-SALEBANER"
					 class="bxr-marker-mobile-names bxr-color-button"
					 data-slide="SALEBANER"
					 data-unicum="<?=$unicum?>">
					<?=GetMessage('SALEBANER_BUTTON')?>
				</div></div>
			<div id="mark-panel-SALEBANER" class="bxr-carousel"></div>
			
			<?
			break;	
		case "NEWBANER":?>
			<div class="col-xs-12 hidden-lg hidden-md hidden-sm">
				<div id="bxr-mobile-name-NEWBANER"
					 class="bxr-marker-mobile-names bxr-color-button"
					 data-slide="NEWBANER"
					 data-unicum="<?=$unicum?>">
					<?=GetMessage('NEWBANER_BUTTON')?>
				</div></div>
			<div id="mark-panel-NEWBANER" class="bxr-carousel"></div>
