    ...
    window.BXReady.Market.Menu =  {
        ...
        fixed: function(){
            ...
            fixedElement.on('affix.bs.affix', function () {
				...
				fixedElement.find('.bxr-ico-menu-top').css({"display": "none"});
				//fixedElement.find('.bxr-ico-menu-top-hover').css({"display": "none"});
				fixedElement.find('.bxr-children-color-hover').css('width', 'auto');
				var w = document.body.clientWidth, new_width = '88%';
				if(w < 1200){ new_width = '90%';}
				//fixedElement.find('.bxr-flex-menu').css('width', new_width);
				fixedElement.find('.basket-fix').css({"display":"block", "marginTop":"8px","marginRight": "32px"});
				fixedElement.find('li.bxr-children-color-hover').children("a").css({'padding': '14px 8px'});
				fixedElement.find('.ph-menu').css({"display": "block"});
				fixedElement.find('#vis').css({"display": "block"});
				$("#topbasket").removeClass('bxr-basket-indicator');
						/*$("#bxr-basket-body:first").removeAttr('id');
						//$(".basket-body-container:eq(0)").removeAttr('id');
						$("#bxr-favor-body:first").removeAttr('id');
						//$(".basket-body-container:eq(2)").removeAttr('id');
						$(".basket-body-container").css({"display": "none"});
						$('[data-fly="basket-fly"]').attr('id','bxr-basket-body');
						//$(".basket-body-container:eq(2)").css({"display": "none"});*/

				$('.left_block').css({'top': '100px'});
          ...
          //  
            ...
            fixedElement.on('affix-top.bs.affix', function () {
                ...
                $('.left_block').css({'top': 'inherit'});
				
				fixedElement.find('.bxr-ico-menu-top').css({"display": "inline"});
				fixedElement.find('.bxr-flex-menu').css('width', '100%');
				fixedElement.find('.basket-fix').css({"display": "none"});
				fixedElement.find('.ph-menu').css({"display": "none"});
				fixedElement.find('#vis').css({"display": "none"});
				//$('ul.bxr-flex-menu > li > ul > li > a').css({'padding': '14px'});
				fixedElement.find('li.bxr-children-color-hover').children("a").css({'padding': '14px 15px', 'margin':'0px 2px'});
				//fixedElement.find('.bxr-ico-menu-top-hover').css({"display": "inline"});
				//$("#bxr-basket-body:eq(1)").removeAttr('id');
						//$("#bxr-favor-body:first").removeAttr('id');
				//$(".basket-body-container:eq(0)").removeAttr('id');		
				//$(".basket-body-container:eq(2)").removeAttr('id');
				/*$('[data-fly="basket-fly"]').removeAttr('id');
				$("#topbasket").addClass('bxr-basket-indicator');
				$(".basket-body-container:first").attr('id','bxr-basket-body');
				$(".basket-body-container:eq(2)").attr('id','bxr-favor-body');*/
        ...
        resize: function(){
			var tmp_w = document.body.clientWidth, new_width = '74%';
			if(tmp_w < 1200){ new_width = '90%'; }
			//if((tmp_w > 1199) && (tmp_w < 1218)){ new_width = 'auto'; }
            //$('ul.bxr-flex-menu').css('width', new_width);

			$('body').find('.affix-top').find('ul.bxr-flex-menu').css('width', '100%');

			if(($('.affix-top').length == 0) && ($('.affix').length == 0))
			{
				$('.basket-menu-fix').css('width', '100%');	
			}
