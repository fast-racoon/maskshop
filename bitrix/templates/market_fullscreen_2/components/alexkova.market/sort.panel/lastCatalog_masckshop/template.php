...
?>
	<div class="col-xs-12 hidden-xs<?=($arParams["THEME"] == 'default') ?' bxr-border-color':' bxr-color-flat'?> bxr-sort-panel">
		<div class="row">
...
$APPLICATION->setAdditionalCss($dirName."/themes/".$arParams["THEME"]."/style.css");
//$APPLICATION->setAdditionalCss("/bitrix/components/alexkova.market/sort.panel/templates/.default/themes/".$arParams["THEME"]."/style.css");
?>