...
<div class="row bxr-list">
    ...
    <?
	//сам задаю значени€, игнориру€ предыдущие настройки
	$arResponsiveParams = array(
	"LG" => 4,
	"MD" => 4,
	"SM" => 6,
	...
	<div id="<?=$strMainID?>" class="t_<?=$unicumID?> col-lg-4<?//=$arResponsiveParams["LG"]?> col-md-4<?//=$arResponsiveParams["MD"]?> col-sm-6<?//=$arResponsiveParams["SM"]?> col-xs-6"> 
            <?
