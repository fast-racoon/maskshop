...
if (!empty($arElements) && is_array($arElements))
{
	...
	$arResponsiveParams = $arDefaultResponsive;
        ...
        if ($managment_element_mode == "Y") {
            ...
            $arResponsiveParams["LG"] = COption::GetOptionString($module_id, "catalog_list_element_count_lg_".SITE_TEMPLATE_ID, 3);
            ...
            $arResponsiveParams["XS"] = COption::GetOptionString($module_id, "catalog_list_element_count_xs_".SITE_TEMPLATE_ID, 6);
        } else {
            $elementLibrary = "ecommerce.v2.lite";
            $arResponsiveParams["LG"] = 3;
            $arResponsiveParams["MD"] = 3;
		...
		array(
			...
			"PAGE_ELEMENT_COUNT" => 16,//$arParams["PAGE_ELEMENT_COUNT"],
