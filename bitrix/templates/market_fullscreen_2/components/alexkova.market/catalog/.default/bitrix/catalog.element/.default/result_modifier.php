...
{
	$productSlider = getSliderForItem($arResult, '', 'Y' == $arParams['ADD_DETAIL_TO_SLIDER']);
}else{
	$productSlider = getSliderForItem($arResult, $arParams['ADD_PICT_PROP'], 'Y' == $arParams['ADD_DETAIL_TO_SLIDER']);
}

//$productSlider = getSliderForItem($arResult, '', 'Y' == $arParams['ADD_DETAIL_TO_SLIDER']);//getSliderForItem($arResult, $arParams['ADD_PICT_PROP'], 'Y' == $arParams['ADD_DETAIL_TO_SLIDER']);

//добавление доп. картинок основного товара
$productSliderDopImages = getSliderForItem($arResult, $arParams['ADD_PICT_PROP'], 'N' == $arParams['ADD_DETAIL_TO_SLIDER']);
/*
global $USER;
if ($USER->IsAdmin())
{
	$productSliderTMPDETAIL = getSliderForItem($arResult, '', 'Y' == $arParams['ADD_DETAIL_TO_SLIDER']);
	print_r($productSliderTMPDETAIL);
	echo "<br><br><br><br>";
	$productSlider = getSliderForItem($arResult, $arParams['ADD_PICT_PROP'], 'N' == $arParams['ADD_DETAIL_TO_SLIDER']);
}
*/
...
if ($arResult['CATALOG'] && isset($arResult['OFFERS']) && !empty($arResult['OFFERS']))
{
	...
	$arResult['MORE_PHOTO'] = array_merge($arResult['MORE_PHOTO'], $productSliderDopImages);
...
foreach($arParams["PREVIEW_DETAIL_PROPERTY_CODE"] as $v):
