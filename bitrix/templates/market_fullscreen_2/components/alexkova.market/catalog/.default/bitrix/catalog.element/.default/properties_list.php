...
<h3 class="bxr-detail-tab-mobile-title  hidden-lg hidden-md hidden-sm hidden-xs"><?=GetMessage("PROPS_TEXT")?></h3>
    <?if (!empty($arResult["PROPERTIES"]["PROP_sposob"]["VALUE"]["TEXT"])) {?>
		<?echo htmlspecialcharsBack($arResult["PROPERTIES"]["PROP_sposob"]["VALUE"]["TEXT"])?>
    <?}else{?>
