...
<?endif;?>
	...
	?>
        <?
        if ($arCurSection["DESCRIPTION"] && $arParams["SHOW_SECTION_DESC"] == "top" && (!isset($_GET['PAGEN_1']) || intval($_GET['PAGEN_1'])<=1)) {?>
...
//			"OFFERS_LIMIT" => $arParams["LIST_OFFERS_LIMIT"],
	...
	?>
        ...
        <?
        if ($arCurSection["DESCRIPTION"] && $arParams["SHOW_SECTION_DESC"] == "bottom" && (!isset($_GET['PAGEN_1']) || intval($_GET['PAGEN_1'])<=1)) {?>
            <div class="bxr-section-desc">
                <?=$arCurSection["DESCRIPTION"]?>
            </div> 
        <?}?>
