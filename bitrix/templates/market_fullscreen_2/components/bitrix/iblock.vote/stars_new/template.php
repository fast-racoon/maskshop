...
?><table class="bx_item_detail_rating" style="width: 100%;">
	<tr>
		<td>
                    <div class="rating-title" style="padding-left: 20px;">
                        <?=GetMessage("TP_CBIV_RATING")?>
                    </div>
                    <div class="bx_item_rating" style="float: right;">
                            <div class="bx_stars_container" style="height: 20px;">
