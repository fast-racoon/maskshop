...
//свернуть раскрыть блок с товарами
	$('#basket_items').readmore({moreLink: '<a href="#" class="readmore-js-toggle basket_step1_more"><span style=>Смотреть все товары <i class="fa fa-caret-down" aria-hidden="true"></i></span></a>',lessLink: '<a href="#" class="readmore-js-toggle basket_step1_more"><span style=>Свернуть <i class="fa fa-caret-up" aria-hidden="true"></i></span></a>',maxHeight: 225});
