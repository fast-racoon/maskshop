...
if ($normalCount > 0):
?>
<div class="count_cart hidden-lg hidden-md">Товаров в корзине: <b><?echo COUNT($arResult["GRID"]["ROWS"]);?></b></div>
				...
				<tr id="<?=$arItem["ID"]?>" <?if($tmpCount == COUNT($arResult["GRID"]["ROWS"])){?>style="border-bottom: none !important;"<?}?>>
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								...
								<td class="item hidden-sm hidden-xs">
							...
							?>
								<td class="custom mobQnt">
									<span class="qnt_span">Количество<?//=$arHeader["name"]; ?>:</span>
									<div class="centered">
							...
							?>
								<td class="custom custom_sum" style="font-weight: bold;">
						...
						if ($bDelayColumn || $bDeleteColumn):
						?>
							<td class="control hidden-sm hidden-xs">
								<?
								if ($bDeleteColumn):
								?>
                                                                <a class="bxr-icon-button-delete-big-baske" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><span class="fa fa-close" aria-hidden="true"></span></a>
...
?>
		...
		<div class="bx_ordercart_order_pay_right">
			<div class="itogo_txt hidden-lg hidden-md" style="text-align: center; font-size: 22px; font-weight: bold; margin-top: 25px;">ИТОГО <span id="allSum_FORMATED3" style="display:none;"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></span></div>
			<table class="bx_ordercart_order_sum">
				...
				<?endif;?>
					...
					<tr>
						<td class="fwb hidden-sm hidden-xs"><?=GetMessage("SALE_TOTAL")?></td>
						<td class="fwb points points_txt hidden-lg hidden-md"><span>Товаров на сумму</span></td>
						<td class="fwb points_txt" id="allSum_FORMATED"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></td>
					</tr>
					<tr>
					</tr>
					<tr class="hidden-lg hidden-md" style="clear:both;">
...
?>
					...
					<tr>
						...
						<td class="custom_t2 hidden-sm hidden-xs" style="text-decoration:line-through; color:#828282;" id="PRICE_WITHOUT_DISCOUNT">
...
<br>
<div class="sum_order_txt hidden-lg hidden-md" style="text-align: center;">Сумма заказа</div>
<div id="allSum_FORMATED2" class="hidden-lg hidden-md" style="text-align: center; font-size: 22px; font-weight: bold;"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></div>
<script>
