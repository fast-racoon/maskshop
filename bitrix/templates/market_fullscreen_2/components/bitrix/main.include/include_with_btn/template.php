...
if($arResult["FILE"] <> '') {?>
    ...
    ?>
	<div class="bxr-phone-number <?=$floatClass?>" style="font-size: 21px;">
        <?$addClass = ($arParams["BTN_TYPE"] == "BTN") ? "bxr-include-with-btn" : "bxr-include-with-link";?>
        <?if ($arParams["SHOW_BTN"] == "Y" && $arParams["BTN_TYPE"] == "BTN") {?>
            <span class="bxr-color bxr-bg-hover-light fa fa-phone open-answer-form bxr-recall-btn greencall" style="float: left;"></span>
        <?}?>        
