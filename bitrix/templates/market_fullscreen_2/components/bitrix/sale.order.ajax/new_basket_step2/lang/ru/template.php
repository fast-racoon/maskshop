...
$MESS['SOA_TEMPL_PAY_SYSTEM'] = "СПОСОБ ОПЛАТЫ";//"Выберите способ оплаты";
...
$MESS['SOA_TEMPL_DELIVERY'] = "СПОСОБ ДОСТАВКИ";//"Веберите способ доставки";
$MESS['SOA_TEMPL_ORDER_SUC'] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно создан.";
$MESS['SOA_TEMPL_ORDER_SUC1'] = "<p class='sucOrderTitleP'>Наш менеджер свяжется с вами для подтверждения заказа. Вы можете следить за выполнением своего заказа в <a href='/personal/main/' class='blue_link_a'>Личном кабинете</a> в разделе <a href='/personal/main/orders/' class='blue_link_a'>Мои заказы</a>.<br><br>За эту покупку на ваш счет начислено <b>100 баллов</b>. Узнать сколько у вас баллов на счете можно в разделе <a href='/personal/main/bonus/' class='blue_link_a'>Скидки и баллы</a>.</p>";//"Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Личном кабинете</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS['SOA_TEMPL_SUM_IT'] = "СУММА ЗАКАЗА:";
...
$MESS['SOA_TEMPL_SUM_COMMENTS'] = "КОММЕНТАРИЙ К ЗАКАЗУ";//"Комментарии к заказу:";
$MESS['SOA_TEMPL_SUM_TITLE'] = "Состав заказа";
$MESS['SOA_TEMPL_ORDER_COMPLETE'] = "Поздравляем, ваш заказ принят!";
...
$MESS['SOA_TEMPL_BUYER_INFO'] = "КОНТАКТНАЯ ИНФОРМАЦИЯ";//"Покупатель";
