BX.saleOrderAjax = { // bad solution, actually, a singleton at the page
	...
	initDeferredControl: function()
	{
		...
		/*$("#sPPDelivery").bind( 'DOMSubtreeModified',function(){ // отслеживаем изменение содержимого блока sPPDelivery(куда доставляем PicPoint)
			$("#desc_delivery").html($("#sPPDelivery").html());
		});*/
