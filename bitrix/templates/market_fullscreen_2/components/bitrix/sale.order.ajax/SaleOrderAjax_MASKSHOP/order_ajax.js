	...
	BX.Sale.OrderAjaxComponent = {
		...
		createPaySystemItem: function(item)
		{
			...
			itemNode = BX.create('DIV', {
				props: {className: 'bx-soa-pp-company col-lg-12 col-sm-4 col-xs-6'},
		...
		editDeliveryItems: function(deliveryNode)
		{
			...
			var deliveryItemsContainer = BX.create('DIV', {props: {className: 'col-sm-12 bx-soa-pp-item-container'}}),
				deliveryInfoContainer = BX.create('DIV', {props: {className: 'col-sm-12 bx-soa-pp-desc-container'}}),
				deliveryItemNode, k, price, currentDelivery, infoList;
...
//alert(currentDelivery);
			...
			for (k = 0; k < this.deliveryPagination.currentPage.length; k++)
			{
				deliveryItemNode = this.createDeliveryItem(this.deliveryPagination.currentPage[k]);
				deliveryItemsContainer.appendChild(deliveryItemNode);
				this.editDeliveryInfo(deliveryItemNode);
			}
//this.editDeliveryInfo(deliveryNode);
		...
		//deliveryItemsContainer.appendChild(deliveryInfoContainer);
		return deliveryItemNode;
			if (this.params.DELIVERY_NO_AJAX != 'Y')
				this.deliveryCachedInfo[currentDelivery.ID] = currentDelivery;
		},

	editDeliveryInfo: function(deliveryNode,deliveryItemNode)
		{
			if (!this.result.DELIVERY)
				return;
	...
	/*		price = BX.create('LI', {
		...
		createDeliveryItem: function(item)
		{
			var checked = item.CHECKED == 'Y',
				...
				logotype, label, title, itemNode, logoNode, price;
				...
				price = BX.create('DIV', {
					children: [
						...
						BX.create('DIV', {
							props: {className: 'bx-soa-pp-list-description'},
							children: this.getDeliveryPriceNodes(deliveryId)
						})
					]
				});
