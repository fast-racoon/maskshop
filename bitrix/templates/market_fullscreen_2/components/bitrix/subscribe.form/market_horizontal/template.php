...
?>
	<form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" onsubmit="yaCounter36717630.reachGoal('SUBSCRIBE'); ga('send', 'event', 'button', 'subscribe'); return true;">
            <?=bitrix_sessid_post()?>
            ...
            <div class="bxr-sender-subscribe-container horizontal container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-2 bxr-subscribe-rubrics">
...
$frame->beginStub();
?>
	<form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" onsubmit="yaCounter36717630.reachGoal('SUBSCRIBE'); return true;">
            <?=bitrix_sessid_post()?>
            <input type="hidden" name="sender_subscription" value="add">
            <div class="bxr-sender-subscribe-container horizontal container-fluid">
                <div class="row">
