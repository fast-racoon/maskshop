	...
	else
	{
		if($arResult["is_ajax_post"] != "Y" && $arResult["CanUserComment"])
		{
			...
			<div id="form_comment_" style="display:none;">
				...
				<form method="POST" name="form_comment" id="<?=$component->createPostFormId()?>" action="<?=$ajaxPath; ?>" onsubmit="yaCounter36717630.reachGoal('otziv'); return true;">
...
//							dbg showComment?
		...
		if($arResult["is_ajax_post"] != "Y")
		{
			if($arResult["CanUserComment"])
			{
				...
				?>
				<div class="blog-add-comment" style="text-align: right; padding-bottom: 7px;"><a class="bx_medium bx_bt_button" href="javascript:void(0)" onclick="yaCounter36717630.reachGoal('napisat_otziv'); return editCommentNew('0', <?=$arParams["ID"]?>)" style="border: 1px solid #dbdbdb;background: #000;color: #fff;border-radius: 2px;padding: 5px 10px;text-decoration: none;"><b><?=GetMessage("B_B_MS_ADD_COMMENT")?></b></a><br /></div>
				<a name="0"></a>
				<?
