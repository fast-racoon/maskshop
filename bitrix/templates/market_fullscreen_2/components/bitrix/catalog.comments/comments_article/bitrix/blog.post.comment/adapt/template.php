			...
			<div id="form_comment_" style="display:none;">
				...
				<div class="blog-comment-fields">
					...
					<div class="<?/*blog-comment-buttons*/?>">
						<input tabindex="10" class="btn_review_ok" value="<?=GetMessage("B_B_MS_SEND")?>" type="button" name="sub-post" id="post-button" onclick="submitCommentNew()">
					</div>
				</div>
			...
			if($comment["SHOW_AS_HIDDEN"] == "Y" || $comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
			{
				...
				if($comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
				{
					...
					<div class="blog-comment-info">
						...
						{
							?>
<?$curImg = "/bitrix/templates/market_fullscreen_2/components/bitrix/catalog.comments/comments_article/bitrix/blog.post.comment/adapt/images/noavatar.gif";
$curMinWidth = "30";
...
{
	$curImg = "/images/icon_logo.svg";
	$curMinWidth = "50";
}?>

			<div class="review-avatar" style="background-color: #ffffff;border: 1px solid #ffffff;max-width: <?=$curMinWidth?>px; display: inline-block;">

				<img src="<?=$curImg?>" border="0" />

			</div>&nbsp;
							<div class="blog-author"><?=$comment["AuthorName"]?></div><br>
							<?
						}
...
//							dbg showComment?
		...
		if($arResult["is_ajax_post"] != "Y")
		{
			if($arResult["CanUserComment"])
			{
				...
				?>
				<div class="" id="preBtnOk" style="text-align: left; padding-bottom: 15px;"><a class="btn_review_ok" href="javascript:void(0)" onclick="$('#preBtnOk').hide(); return editCommentNew('0', <?=$arParams["ID"]?>)" style="color: #fff;text-decoration: none;"><b><?=GetMessage("B_B_MS_ADD_COMMENT")?></b></a><br /></div>
				<a name="0"></a>
				<?
