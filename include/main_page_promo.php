<div id="bxr-opportunities" class="hidden-xs hidden-sm">
...
<?/*$APPLICATION->IncludeComponent("alexkova.market:promo", "ribbon", Array(
	"CACHE_TIME" => "36000",	// Время кеширования (сек.)
		"CACHE_TYPE" => "A",	// Тип кеширования
		"COMPONENT_TEMPLATE" => "ribbon",
		"DISPLAY_TYPE" => "block",	// Тип отображения
		...
		"HOVER_EFFECT" => "approx",	// Эффект при наведении
		"IBLOCK_ID" => "6",	// Инфоблок
		"IBLOCK_TYPE" => "content",	// Тип инфоблока
		"INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
		"NEWS_COUNT" => "10",	// Количество элементов на странице
		"PARENT_SECTION" => "0",	// Раздел
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"TAB_HIT_SETTING" => "Y",
		"TAB_HIT_SORT" => "400",
		"TAB_MONTHHIT_SETTING" => "N",
		"TAB_MONTHHIT_SORT" => "400",
		"TAB_MUSTHAVE_SETTING" => "N",
		"TAB_MUSTHAVE_SORT" => "400",
		"TAB_NEWBANER_SETTING" => "N",
		"TAB_NEWBANER_SORT" => "400",
		"TAB_NEW_SETTING" => "Y",
		"TAB_NEW_SORT" => "200",
		"TAB_RECCOMEND_SETTING" => "N",
		"TAB_RECCOMEND_SORT" => "300",
		"TAB_SALEBANER_SETTING" => "N",
		"TAB_SALEBANER_SORT" => "400",
		"USE_PRICE_COUNT" => "N",
